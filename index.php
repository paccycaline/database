            ...
            <div class="nav-menu">
                <nav class="mainmenu mobile-menu">
                    <ul>
                        ...
                        <li><a href="./speaker.php">Events</a>
                            <ul class="dropdown">
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="hero-text">
                        ...
                        <a href="login.php" class="primary-btn">Buy Ticket</a>
                    </div>
                </div>
                <div class="col-lg-5">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-8">
                    <div class="price-item">
                        <h4>1 Day Pass</h4>
                        <div class="pi-price">
                            <h2><span>RWF</span>50,000</h2>
                        </div>
                        <ul>
                            <li>One Day Concert show</li>
                            <li>Coffee-break</li>
                            <li>Lunch and albuming</li>
                            <li>Bruce melod talk</li>
                            <li>Talk to the upcaming artist</li>
                        </ul>
                        <a href="login.php" class="price-btn">Get Ticket <span class="arrow_right"></span></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-8">
